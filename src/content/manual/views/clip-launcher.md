...
- **Columns** are tracks
- **Rows** are scenes
- **Cells** contain clips or empty slots
...
Tap an empty cell to create a new clip. The piano roll opens so you can start writing notes.

### Launch a clip

Tap a clip to start it playing. It will begin on the next bar.

### Edit a clip

Double-tap a clip to open it in the piano roll for editing.
...
Tap the scene button on the right side of a row. All clips in that row start together.
...
- The clip launcher is designed for touch — big targets, simple gestures
